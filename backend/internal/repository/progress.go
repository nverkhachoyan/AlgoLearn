...
type ProgressRepository interface {
	...
	GetCourseProgressSummary(ctx context.Context, userID int64, courseID int64) (*models.CourseProgress, error)
	GetCourseProgressFull(ctx context.Context, userID int64, courseID int64) (*models.CourseProgress, error)
	GetCoursesProgressSummary(ctx context.Context, page int, pageSize int, userID int64, queryFilter string) (int64, []models.CourseProgress, error)
}
...
func (r *progressRepository) GetCoursesProgressSummary(ctx context.Context, page int, pageSize int, userID int64, queryFilter string) (int64, []models.CourseProgress, error) {
	...
	for rows.Next() {
		...
		if !unitID.Valid {
			...
			course.CurrentUnit = &models.UnitProgress{
		...
		if !moduleID.Valid {
			...
			course.CurrentModule = &models.ModuleProgress{
				BaseModel: models.BaseModel{
					ID:        moduleID.Int64,
...
func (r *progressRepository) GetCourseProgressSummary(ctx context.Context, userID int64, courseID int64) (*models.CourseProgress, error) {
...
func (r *progressRepository) GetCourseProgressFull(ctx context.Context, userID int64, courseID int64) (*models.CourseProgress, error) {
	log := logger.Get().WithBaseFields(logger.Repository, "GetCourseProgress")
