    ...
    <Animated.View style={[styles.controlsWrapper, { opacity }]}>
      <View style={styles.minimalControls}>
        <TouchableOpacity style={styles.controlButton} onPress={onReset} activeOpacity={0.7}>
          <MaterialCommunityIcons name="restart" size={18} color={primaryColor} />
        </TouchableOpacity>

        <TouchableOpacity
          style={[styles.controlButton, styles.playPauseButton, { backgroundColor: primaryColor }]}
          onPress={onPlayPause}
          activeOpacity={0.7}
        >
        ...
        <TouchableOpacity
          ...
          ref={speedButtonRef}
        >
          <Text style={[styles.speedText, { color: primaryColor }]}>{speedMultiplier}x</Text>
