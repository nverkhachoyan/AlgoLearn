...
export default function CourseInfo({ course, colors }: { course: Course; colors: Colors }) {
  return (
    <View style={styles.courseDescriptionContainer}>
      <InfoSection
        icon={<MaterialIcons name="description" size={24} color={colors.onSurface} />}
        title="Description"
      ...
      />
      <InfoSection
        icon={<AntDesign name="codesquare" size={24} color={colors.onSurface} />}
