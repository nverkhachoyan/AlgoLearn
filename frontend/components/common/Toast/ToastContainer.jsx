...
class ToastContainer extends Component {
  ...
  static propTypes = {
    ...
    slideFrom: PropTypes.oneOf(["top", "bottom"]),
  };
  ...
  static defaultProps = {
    ...
    slideFrom: "bottom", // Default slide direction is from the bottom
  };
  ...
  constructor() {
    ...
    this.state = {
      ...
      translateY: new Animated.Value(
        this.props.slideFrom === "top" ? -window.height : window.height,
  ...
  _show = () => {
    ...
    if (!this._animating) {
      ...
      const initialTranslateValue =
        this.props.slideFrom === "top"
          ? -this.state.windowHeight
          : this.state.windowHeight;
      this.state.translateY.setValue(initialTranslateValue); // Reset initial position
  ...
  _hide = () => {
    ...
    if (!this._animating) {
      ...
      Animated.parallel([
        ...
        Animated.timing(this.state.translateY, {
          toValue: finalTranslateValue, // Slide out of view
          duration: this.props.animation ? TOAST_ANIMATION_DURATION : 0,
          easing: Easing.in(Easing.ease),
          useNativeDriver: true,
        }),
