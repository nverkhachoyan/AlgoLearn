...
interface ButtonProps {
  ...
  style?: StyleProp<ViewStyle>; // Style for the Pressable
...
export default function Button(props: ButtonProps) {
  const { onPress, title, icon, style, textStyle, iconStyle, disabled, ...rest } = props;
  ...
  const renderIcon = () => {
    ...
    if (type === 'png') {
      return <Image source={src} style={[styles[`icon${icon.position}`], iconStyle]} />;
    }
